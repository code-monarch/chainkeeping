	...
	function ({ addBase }) {
		addBase({
			":root": {
				...
				"--destructive-foreground": "0, 71%, 97%, 1",
			...
			".dark": {
				...
				"--success": "145, 63%, 42%, 1",
				"--success-foreground": "0, 0%, 100%, 1",
				"--success-primary-foreground": "hsla(145, 68%, 94%, 1)",
				"--warning": "43, 93%, 66%, 1",
				"--warning-foreground": "0, 0%, 0%, 1",
				"--ring": "215 20.2% 65.1%",
				"--radius": "0.5rem",
			...
			extend: {
				colors: {
					...
					success: {
						...
						accent: "hsl(var(--success-foreground))",
						foreground: "hsl(var(--success-primary-foreground))",
					},
				},
				boxShadow: {
					"card-shadow":
						"box-shadow: 0px 4px 8px 0px hsla(194, 90%, 12%, 0.05), 1px -4px 8px 0px hsla(194, 90%, 12%, 0.05)",
				},
				borderRadius: {
