...
import PasswordInputLockIcon from "../../../../../landing/src/pattern/common/atoms/password-input-lock-icon";
import PasswordToggleIcon from "../../../../../landing/src/pattern/common/atoms/password-toggle-icon";
