...
import TwtAccountIcon from "../atoms/twt-account-icon";

import KucoinAccountIcon from "../atoms/kucoin-account-icon";
import OptimismAccountIcon from "../atoms/optimism-account-icon";
...
export const BinanceAccount = () => <BCWIcon />;

export const MetamaskAccount = () => <MetamaskAccountIcon />;

export const AvalancheAccount = () => <AvalancheAccountIcon />;

export const CoinBaseAccount = () => <CoinbaseAccountIcon />;
export const TrustwalletAccount = () => <TwtAccountIcon />;
