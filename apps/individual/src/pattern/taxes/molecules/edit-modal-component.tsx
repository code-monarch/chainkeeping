...
const EditModalCOmponent: React.FC<ModalProps> = ({
	isOpen,
	onClose,
	children,
	title,
	...
	return (
		...
		>
			<div
				className={`bg-white rounded-lg w-11/12 sm:w-1/2 md:w-[500px] shadow-lg transform transition-all duration-300 ease-in-out ${
