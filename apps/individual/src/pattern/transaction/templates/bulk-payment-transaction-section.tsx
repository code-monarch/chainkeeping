...
import BulkPaymentTable from "../organisms/bulk-payment-table";
import { BulkPaymentTransactionData } from "../molecules/bulk-payement-data";
import BulkPaymentTransactionTable from "../organisms/bulk-payment-transactions";

const BulkPaymentTransactionSection = () => {
			...
			{hasAccount ? (
				<div className='md:px-16 flex h-full gap-4 justify-between pt-10 max-sm:px-4 max-sm:flex-col'>
					<div className='flex-col flex gap-4 w-full'>
						<BulkPaymentTransactionTable data={BulkPaymentTransactionData} />
					</div>
				</div>
			) : (
...
export default BulkPaymentTransactionSection;
