...
export default function RootLayout({
	...
	return (
		...
		<html lang='en'>
			<body
				className={`${sen.variable} ${inter.variable} ${dmsans.variable} ${rubik.variable} ${space_Grotesk.variable} antialiased relative bg-background w-screen min-h-svh h-fit m-0 p-0 overflow-x-hidden`}
			>
