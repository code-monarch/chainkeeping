const OverviewIcon = () => {
	return (
		...
		>
			...
			/>
			<path
				d='M9.4975 14.8678L11.2825 12.5503C11.5375 12.2203 12.01 12.1603 12.34 12.4153L13.7125 13.4953C14.0425 13.7503 14.515 13.6903 14.77 13.3678L16.5025 11.1328'
				stroke='#292D32'
				strokeWidth='1.5'
				strokeLinecap='round'
				strokeLinejoin='round'
