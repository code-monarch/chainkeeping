					...
					<div key={link.name} className='w-full flex flex-col'>
						<Link href={link.href}>
							...
							<div
								className={cn(
									...
									isActive
										? "border-destructive bg-[#FEFAFA]"
										: "border-transparent text-forground"
								)}
							>
						...
						{isActive && (
							<div className='py-2 cursor-pointer px-10 flex text-center w-full items-center gap-3 group'>
								<div className='p-1 text-[#4F627D] bg-accent rounded transition-all ease-in-out duration-300 group-hover:bg-accent group-hover:text-destructive'>
									<IoMdAdd />
								</div>
