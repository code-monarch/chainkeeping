            ...
            <div className='w-full md:container flex items-start justify-between gap-16'>
                ...
                <div className='w-full max-w-[984px] space-y-[32px]'>
                    <div className='w-full flex flex-col gap-y-4'>
                        <h3 className='text-[2.8rem] font-rubik font-semibold'>Privacy policy</h3>
                        <LastUpdatedWidget lastUpdate={LAST_UPDATE} />
                    </div>
                    <div id="intro" className='w-full flex flex-col gap-y-4'>
                        <h3 className='text-[2rem] text-foreground font-rubik font-semibold'>1. Introduction</h3>
                    ...
                    <div id="data-collection" className='w-full flex flex-col gap-y-4'>
                        <h3 className='text-[2rem] text-foreground font-rubik font-semibold'>2. Data collection and uses</h3>
                    ...
                    <div id="information-we-collect" className='w-full flex flex-col gap-y-4'>
                        <h3 className='text-[2rem] text-foreground font-rubik font-semibold'>3. Information we collect</h3>
                        <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>i. Information you provide</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                                This may include:
                            </p>
                            <ul className='list-disc text-gray-600 leading-[26px] font-dmsans font-normal pl-6'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>ii. Information created when you use our services</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                                This may include:
                            </p>
                            <ul className='list-disc text-gray-600 leading-[26px] font-dmsans font-normal pl-6'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>iii. Information from other sources</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                                This may include:
                            </p>
                            <ul className='list-disc text-gray-600 leading-[26px] font-dmsans font-normal pl-6'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>iv. How we use your information</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                                This may include:
                            </p>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        {/* Safety And Security */}
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>v. Safety And Security</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        {/* Customer Support */}
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>vi. Customer Support</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>vii. Research And Development</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>viii. Communications from CloudGo</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>ix. Legal Proceedings And Requirements</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                    ...
                    <div id="cookies" className='w-full flex flex-col gap-y-4'>
                        <h3 className='text-[2rem] text-foreground font-rubik font-semibold'>4. Cookies And Third Party Technologies</h3>
                        <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                    ...
                    <div id="information-retention" className='w-full flex flex-col gap-y-4'>
                        <h3 className='text-[2rem] text-foreground font-rubik font-semibold'>6. Information Retention And Deletion</h3>
                        <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                    ...
                    <div id="choice-and-transparency" className='w-full flex flex-col gap-y-4'>
                        <h3 className='text-[2rem] text-foreground font-rubik font-semibold'>7. Choice And Transparency</h3>
                        <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        {/* i. Privacy Settings */}
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>i. Privacy Settings</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>ii. Device Permissions</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>iii. Explanations, Copies, And Correction</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                        ...
                        <div className='w-full flex flex-col gap-y-4'>
                            <h3 className='text-2xl text-foreground font-rubik font-semibold'>iv. Marketing Opt-Outs</h3>
                            <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
                    ...
                    <div id="updates-to-the-policy" className='w-full flex flex-col gap-y-4'>
                        <h3 className='text-[2rem] text-foreground font-rubik font-semibold'>8 Updates to this policy</h3>
                        <p className='text-base text-gray-600 leading-[26px] font-dmsans font-normal'>
