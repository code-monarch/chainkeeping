...
const Footer = () => {
    ...
    return (
        <div className='bg-primary w-full h-fit md:h-[420px]'>
            <div className='w-full h-full flex flex-col justify-between gap-y-[96px] py-[56px] px-[18px] md:container'>
                <div className='w-full h-fit md:h-[180px] flex flex-col md:flex-row md:items-start md:justify gap-[50px]'>
                    <Link href={APP_ROUTES.index}>
                        <BrandLogoWhite />
                    </Link>
                    {/* Solutions */}
                    <div className='h-fit xl:min-w-[972px] 2xl:w-full flex flex-col md:flex-row items-start gap-6 justify-between'>
                        {/* Solutions */}
                ...
                {/* Bottom */}
                <div className='h-[72px] w-full flex flex-col md:flex-row md:items-center md:justify-between gap-y-6 py-6 border-t'>
                    <CopyrightText />
