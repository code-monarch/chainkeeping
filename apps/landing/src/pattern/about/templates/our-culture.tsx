...
const OurCulture = () => {
    return (
        <div className='w-full flex flex-col items-start gap-y-12 px-[18px] lg:container'>
            <div className='w-full max-w-[580px] space-y-[18px]'>
                <div className='w-full text-center space-y-[4px]'>
                    ...
                    <Typography className='w-full text-left text-2xl lg:text-[2.25rem] leading-[28.44px] lg:leading-[42.66px] after:w-[94px] lg:after:w-[580px] after:left-0'>What sets us apart from others?</Typography>
                </div>
                <p className='w-full lg:w-[580px] text-foreground text-base leading-[22px] font-dmsans'>We know how overwhelming and tasking crypto taxes and financial reporting can be, so we built Chainkeeping to simplify and solve this process for you. This is why we are the most preferred crypto tax and accounting solution..</p>
            </div>
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-4 gap-4 mx-auto">
