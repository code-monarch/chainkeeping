    ...
    <div className='w-full max-w-[560px] flex flex-col items-start gap-y-4'>
      ...
      <div className='w-full space-y-[18px]'>
        <div className='w-full text-left space-y-[4px]'>
          ...
          <Typography className='w-fit text-left text-2xl lg:text-[2rem] text-white font-rubik leading-[28.44px] lg:leading-[37.97px] after:w-[59px] lg:after:w-[529px] after:left-0'>Harmonize global crypto tax laws</Typography>
        </div>
