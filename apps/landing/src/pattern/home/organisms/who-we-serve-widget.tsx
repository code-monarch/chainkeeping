...
const WhoWeServeWidget: FC<IWhoWeServeWidgetProps> = ({ description, href, icon, label, title }) => {
    ...
    return (
        <>
            <Card
                className="col-span-1 h-[364pxpx] flex flex-col gap-3 p-0 py-3 md:p-8 md:py-8 border-none shadow-none">
                <CardHeader className='w-full flex flex-col gap-3'>
                    ...
                    <CardTitle className='text-xl md:text-2xl font-bold font-rubik'>
                        {title}
                    </CardTitle>
                </CardHeader>
